...
def reconstruct(I, Iresized, Yr, vehicle_type, lp_threshold):
...
def detect_lp(model, I, max_dim, vehicle_type, lp_threshold):
    ...
    Yr = np.squeeze(Yr)
    #print(Yr.shape)
    L, TLp, lp_type, Cor = reconstruct(I, Iresized, Yr, vehicle_type, lp_threshold)
