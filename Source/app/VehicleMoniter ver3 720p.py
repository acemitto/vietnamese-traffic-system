...
def getDataCrossedTheLight(id, data_deque, object_speed, obj_name):
    if data_deque[1][1]>yl2 and data_deque[0][1]<yl2:
        ...
        location = 'nguyen Van Cu, Q5, TPHCMi'
...
cap=cv2.VideoCapture('/Users/acemitto/Desktop/Copy of MVI_1255.mp4') # 0 stands for very first webcam attach
...
filename="/Users/acemitto/Desktop/Copy of MVI_1255-Output.mp4"
