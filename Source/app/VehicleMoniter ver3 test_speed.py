...
# kiểm tra vận tốc
def  checkSpeed(kmh,bimg, obj_name):
...
def UI_box(x, img, kmh, obj_name, color=None, label=None, id=id, line_thickness=None):
    ...
    for i, box in enumerate(bbox):
        ...
        if len(data_deque[id]) >= 2:
            if obj_name == 'motorcycle':
                xy_speed_1=(data_deque[id][0][0]*7,data_deque[id][0][1]*3)
                xy_speed_2=(data_deque[id][1][0]*7,data_deque[id][1][1]*3)
            else:
                xy_speed_1=(data_deque[id][0][0]*7,data_deque[id][0][1]*6)
                xy_speed_2=(data_deque[id][1][0]*7,data_deque[id][1][1]*6)

            object_speed = estimate_speed(xy_speed_1, xy_speed_2, obj_name)
        ...
        UI_box(box, img, speed_check, obj_name, label=label, color=color, id=id ,line_thickness=1)
        # draw trail
...
cap=cv2.VideoCapture('/Users/acemitto/Desktop/STUDY/ACE/CAPSTONE/vietnamese-traffic-system/Source/Traffic-Rule-Violation-Detection-System-master/VietnamTraffic720p.mp4') # 0 stands for very first webcam attach
...
filename="/Users/acemitto/Desktop/STUDY/ACE/CAPSTONE/vietnamese-traffic-system/Source/Traffic-Rule-Violation-Detection-System-master/VietnamTraffic720p-output.mp4"
