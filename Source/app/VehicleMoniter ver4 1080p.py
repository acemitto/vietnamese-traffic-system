...
with open('/Users/acemitto/Desktop/STUDY/ACE/CAPSTONE/vietnamese-traffic-system/Source/Traffic-Rule-Violation-Detection-System-master/Rule Breakers/CSV/traffic_measurement_'+datetime.today().strftime('%Y%m%d')+'.csv', 'w') as f:
    writer = csv.writer(f)
    csv_line = \
        'STT| id| Time| Location| Type| Speed (km/h)| Speed'
...
stt_all = 0
def getDataCrossedTheLight(id, object_speed, obj_name):
    global stt_all
    stt_all = stt_all + 1
    id = str(id)
    status = str(stt_all)
    ...
    if csv_line != 'not_available':
        ...
        with open('/Users/acemitto/Desktop/STUDY/ACE/CAPSTONE/vietnamese-traffic-system/Source/Traffic-Rule-Violation-Detection-System-master/Rule Breakers/CSV/traffic_measurement_'+datetime.today().strftime('%Y%m%d')+'.csv', 'a') as f:
            writer = csv.writer(f)
            csv_line_queue = status+'| '+id+'| '+time_obj+'| '+location+'| '+vehicle_type+'| '+vehicle_speed+'| '+data_signal
...
polygons = [ np.array([
    [537, 400],[1310, 400],[2075, 1080],[130, 1080]
])]
polygons2 = [ np.array([
    [0, 0],[1920, 0],[1920, 1080],[0, 1080]
])]

cap=cv2.VideoCapture('/Users/acemitto/Desktop/STUDY/ACE/CAPSTONE/vietnamese-traffic-system/Source/Traffic-Rule-Violation-Detection-System-master/VietnamTraffic.mp4') # 0 stands for very first webcam attach
...
# filename="/Users/acemitto/Desktop/STUDY/ACE/CAPSTONE/vietnamese-traffic-system/Source/Traffic-Rule-Violation-Detection-System-master/VietnamTraffic-output.mp4"
