...
cap=cv2.VideoCapture('/Users/acemitto/Desktop/video 3 cross red light.mp4') # 0 stands for very first webcam attach
...
# filename="/Users/acemitto/Desktop/video 3 cross red light-output2.mp4"
...
def main(sess=''):
	if True:
		...
		display3.configure(text='Warning: Crossed Yellow Light')
	window.after(1, main)
...
display3 = tk.Label(frame3,text="",font = "verdana 14 bold",fg='yellow')
