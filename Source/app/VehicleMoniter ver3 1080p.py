...
polygons = [ np.array([
    [0, 350],[1920, 350],[1920, 1010],[0, 1010]
])]
polygons2 = [ np.array([
    [520, 350],[1250, 350],[1920, 1010],[100, 1010]
])]
cap=cv2.VideoCapture('/Users/acemitto/Desktop/STUDY/ACE/STOCK/testData/Source/Traffic-Rule-Violation-Detection-System-master/VietnamTraffic.mp4') # 0 stands for very first webcam attach
