...
def getDataCrossedTheLight(id, data_deque, object_speed, obj_name):
    if data_deque[1][1]>yl2 and data_deque[0][1]<yl2:
        ...
        location = 'Nguyen Tri Phuong, Hai Chau, Da Nang'
...
polygons = [ np.array([
    [313, 155],[900, 155],[1200, 675],[0, 675]
])]
polygons2 = [ np.array([
    [0, 350],[1280, 350],[1280, 710],[0, 710]
])]

cap=cv2.VideoCapture('/Users/acemitto/Desktop/STUDY/ACE/CAPSTONE/vietnamese-traffic-system/Source/Traffic-Rule-Violation-Detection-System-master/IMG_4620.mp4') # 0 stands for very first webcam attach
...
filename="/Users/acemitto/Desktop/STUDY/ACE/CAPSTONE/vietnamese-traffic-system/Source/Traffic-Rule-Violation-Detection-System-master/IMG_4620-Output.mp4"
...
def main(sess=''):
    if True:
        ...
        cv2.line(frame, (int(xl1),int(yl1)), (int(xl2),int(yl2)), (0,380,0),1)
