...
polygons_lane = [
	np.array([
		[633, 420],[3305, 420],[4749, 2160],[-353, 2160]
	])
]

polygons = [
	np.array([
		[633, 420],[1309, 420],[866, 2160],[-353, 2160]
	]),
	np.array([
		[1350, 420],[2011, 420],[2133, 2160],[929, 2160]
	]),
	np.array([
		[2050, 420],[3305, 420],[4749, 2160],[2187, 2160]
	])
]

cap=cv2.VideoCapture('/Users/acemitto/Desktop/STUDY/ACE/CAPSTONE/5. VIDEO/0. SOURCES VIDEO/A001_07101641_C021.mp4') # 0 stands for very first webcam attach
...
filename='/Users/acemitto/Desktop/YOLOv9 over person 3.mp4'
