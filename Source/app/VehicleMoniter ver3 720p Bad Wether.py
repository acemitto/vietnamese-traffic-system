...
polygons = [ np.array([
    [342, 329],[794, 329],[928, 676],[8, 676]
])]
polygons2 = [ np.array([
    [0, 350],[1280, 350],[1280, 710],[0, 710]
])]

cap=cv2.VideoCapture('/Users/acemitto/Desktop/STUDY/ACE/CAPSTONE/vietnamese-traffic-system/Source/Traffic-Rule-Violation-Detection-System-master/MVI_1271.MP4') # 0 stands for very first webcam attach
...
filename="/Users/acemitto/Desktop/STUDY/ACE/CAPSTONE/vietnamese-traffic-system/Source/Traffic-Rule-Violation-Detection-System-master/MVI_1271-output.MP4"
...
def main(sess=''):
    if True:
        ...
        cv2.line(frame, (int(xl1),int(yl1)), (int(xl2),int(yl2)), (0,291,0),1)
