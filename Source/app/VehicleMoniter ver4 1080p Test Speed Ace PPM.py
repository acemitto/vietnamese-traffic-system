...
cap=cv2.VideoCapture('/Users/acemitto/Desktop/Ace.mp4') # 0 stands for very first webcam attach
...
filename="/Users/acemitto/Desktop/Ace-ppm-output.mp4"
...
def main(sess=''):
    if True:
        ...
        frame_rs=cv2.resize(frame,(647,1020))
