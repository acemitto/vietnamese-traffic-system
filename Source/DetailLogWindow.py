...
class DetailLogWindow(QMainWindow):
    def __init__(self, data, parent=None):
        ...
        loadUi("/Users/acemitto/Desktop/STUDY/ACE/CAPSTONE/vietnamese-traffic-system/Source/UI/DetailLog.ui", self)
        self.data = data
    ...
    def initData(self):
        print(self.data[KEYS.LICENSEIMAGE])
        self.cam_id.setText(str(self.data[KEYS.CARID]))
        self.car_type.setText(self.data[KEYS.CARTYPE])
