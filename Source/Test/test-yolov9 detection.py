...
def draw_boxes(img, bbox, names, object_id, cur_time, identities=None, offset=(0, 0)):
	...
	for i, box in enumerate(bbox):
		...
		if len(data_deque[id]) >= 2:
			...
			UI_box(box, img, obj_name, data_deque[id], label=label, color=color, id=id ,line_thickness=3 )
...
print("model loaded")
print("Names: ", model_helmet.names)
...
polygons = [
	np.array([
		[1255, 637],[2635, 637],[3461, 2160],[150, 2160]
	])
]

cap=cv2.VideoCapture('/Users/acemitto/Desktop/STUDY/ACE/CAPSTONE/5. VIDEO/0. SOURCES VIDEO/A001_07041619_C002.mp4') # 0 stands for very first webcam attach
...
filename="/Users/acemitto/Desktop/Test YOLOv9 helmet.mp4"
